...
public class ResumeDAO extends BaseHibernateDAO {
	...
	public static final String PERSONAL_HONOR = "personalHonor";
	...
	public Resume findById(java.lang.String id) {
		log.debug("getting Resume instance with id: " + id);
		
		try {
			Resume instance = (Resume) getSession().get("dom.Resume", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Resume instance) {
		...
		try {
			List results = getSession().createCriteria("dom.Resume")
	...
	public List findByTechnology(Object technology) {
		return findByProperty(TECHNOLOGY, technology);
	}
	...
	public List findByPersonalHonor(Object personalHonor) {
		return findByProperty(PERSONAL_HONOR, personalHonor);
	}

	public List findBySlogan(Object slogan) {
		return findByProperty(SLOGAN, slogan);
	}
